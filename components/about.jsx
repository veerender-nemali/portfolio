        ...
        <div className="w-full">
          <div className="grid gap-20 lg:grid-cols-[1.2fr_0.8fr]">
            ...
            <div>
              ...
              <h2 className="mt-6 text-4xl leading-tight font-semibold tracking-tight md:text-5xl">
              ...
              <div className="text-muted-foreground mt-10 space-y-6 text-lg leading-relaxed">
                ...
                <p>
                  ...
                  Data Structures & Algorithms, exploring system design, and
                  building production-ready applications with modern web
                  technologies.
                </p>
